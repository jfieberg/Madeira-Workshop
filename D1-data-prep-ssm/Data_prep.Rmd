...
According to Johnson et al (2008), if the time difference between two time steps is $\Delta = 3/\beta$, then the velocities are roughly independent. Here, this would be achieved in the following time (in hour):
