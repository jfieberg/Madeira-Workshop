...
```{r tmbOpt, attr.source = ".numberLines", tidy=FALSE}
...
```{r toy.states.est, attr.source = ".numberLines", tidy=FALSE}
...
```{r polar.bear.nlminb, attr.source = ".numberLines"}
...
```{r pbTMBpar, attr.source = ".numberLines"}
...
```{r polar.bear.plot.states, attr.source = ".numberLines"}
plot(zsPbTmb, 
...
legend("top",
       legend = c("Obs.", "Estimated latent states"),
       pch = c(3, 19),
       col = c("blue", "red"),
       lty = c(3, 1),
       horiz=TRUE, bty="n", cex=0.9)
