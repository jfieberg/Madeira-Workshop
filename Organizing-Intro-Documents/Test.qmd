...
pkg.required <- append(pkg.required,c("momentuHMM", "aniMotum"))
...
Test fitting a state-space model with data from package
...
# Test for crawlWrap multiple imputation
...
MI_sims <- MIfitHMM(crwOut1, nSims = 4, fit = FALSE)
```
