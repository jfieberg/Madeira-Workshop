...
Requested on Fri Apr 12 07:11:59 CEST 2019
Access key: 5495840174813003344
Requested by: Johannes Signer
Grid origin (longitude:latitude): -74.0:43.0
Grid shape (degrees east:south from origin): 1.0:-0.5
Number of tiles: 1:1
Grid size (pixels): 120:60
...
Name: SEDAC GPW V3 and GRUMP V1 GRUMP 2000 Population Density Adjusted
...
Service: NASA Socioeconomic Data and Applications Center (SEDAC)/Gridded Population of the World (GPW V3 and GRUMP V1)
...
Source link: http://sedac.ciesin.columbia.edu/data/collection/gpw-v3/sets/browse
